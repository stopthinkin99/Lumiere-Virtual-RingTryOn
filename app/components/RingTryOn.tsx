      ...
      <style>{`
        ...
        *, *::before, *::after {
        ...
        .brand-logo {
          ...
          box-shadow: 0 12px 34px rgba(0,0,0,.34), 0 0 24px rgba(201,168,50,.08);
        }
        ...
        @media (max-width:768px) {
          ...
          .intro-grid {
            ...
            padding: 38px 20px 96px !important;
                ...
                >
                  <div
                    style={{
                      ...
                      inset:-26,
                      borderRadius:'50%',
                      background:'radial-gradient(circle, rgba(255,220,160,0.55) 0%, rgba(255,220,160,0.22) 32%, rgba(255,220,160,0.08) 55%, transparent 78%)',
                      filter:'blur(16px)',
                  ...
                  <img
                    ...
                    style={{
                      ...
                      filter:'brightness(1.2) saturate(1.15) drop-shadow(0 0 10px rgba(255,220,160,0.38)) drop-shadow(0 0 24px rgba(255,220,160,0.28)) drop-shadow(0 0 42px rgba(255,220,160,0.16))',
                    }}
                  />
                </div>
              ))}
          ...
          <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
            <div className="tryon-layout">
              ...
              <div className="tryon-right">
                <div>
                  <div style={{ fontSize:11, color:'var(--gold)', letterSpacing:'.25em', textTransform:'uppercase', marginBottom:4 }}>
                    Selected Ring
                  </div>

                  <h2 className="serif" style={{ fontSize:20, fontWeight:300, lineHeight:1.16, marginBottom:3 }}>
                    {selectedRing.name}
                  </h2>
                  ...
                  <div style={{ fontSize:18, color:'var(--gold)', fontWeight:500, marginTop:4 }}>
                    ...
                    {RING_CATALOG.map(r => (
                      ...
                      >
                        <div style={{ width:48, height:30, display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden' }}>
                          <img
                            src={r.colors[0].image}
                            alt={r.name}
                            style={{
                              width:r.rotation === 90 ? '55%' : '100%',
                              height:'100%',
                              objectFit:'contain',
                        ...
                        <div
                          style={{
                            fontSize:8.5,
                            color:selectedRingId === r.id ? 'var(--gold)' : 'var(--muted)',
                            textAlign:'center',
                            lineHeight:1.3,
                            fontWeight:selectedRingId === r.id ? 600 : 400,
                          }}
                        >
                ...
                <div>
                  <div className="ctrl-label">
                    Metal <span>{selectedColor.label}</span>
                  </div>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
                  <div>
                    <div className="ctrl-label">
                      Ring Size <span>{Math.round(ringSize)}px</span>
                    </div>
                  ...
                  <div>
                    <div className="ctrl-label">
                      Rotate <span>{Math.round(ringRotation)}°</span>
                    </div>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background:photoSaved ? 'oklch(74% 0.12 78 / 0.1)' : 'transparent',
                    ...
                    >
                      ...
                      <div style={{ flex:1 }}>
                        ...
                        <div style={{ fontSize:13, color:'var(--gold)' }}>
                          ${item.ring.price.toLocaleString()}
                        </div>
                      </div>
