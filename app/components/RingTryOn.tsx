...
const RING_CATALOG = [
  {
    id: 'solitaire',
    name: 'Solitaire Round Brilliant',
    description: 'Six-prong classic solitaire',
    price: 2490,
    colors: [
      { id: 'gold',      label: '18K Gold',    swatch: 'linear-gradient(135deg,#f0d898,#c9973a)', image: '/rings/1_Gold.png' },
      { id: 'rose',      label: 'Rose Gold',   swatch: 'linear-gradient(135deg,#f4c0b4,#d47060)', image: '/rings/1_Rose_Gold.png' },
      { id: 'yellow',    label: 'Yellow Gold', swatch: 'linear-gradient(135deg,#f5e070,#c8a020)', image: '/rings/1_Yello_Gold.png' },
    ],
  },
  {
    id: 'halo',
    ...
    colors: [
      { id: 'gold',      label: '18K Gold',    swatch: 'linear-gradient(135deg,#f0d898,#c9973a)', image: '/rings/1_Gold.png' },
      { id: 'rose',      label: 'Rose Gold',   swatch: 'linear-gradient(135deg,#f4c0b4,#d47060)', image: '/rings/1_Rose_Gold.png' },
      { id: 'platinum',  label: 'Platinum',    swatch: 'linear-gradient(135deg,#e8e8f0,#a0a0b8)', image: '/rings/1_Yello_Gold.png' },
    ],
  },
  {
    id: 'three-stone',
    ...
    colors: [
      { id: 'gold',      label: '18K Gold',    swatch: 'linear-gradient(135deg,#f0d898,#c9973a)', image: '/rings/1_Gold.png' },
      { id: 'rose',      label: 'Rose Gold',   swatch: 'linear-gradient(135deg,#f4c0b4,#d47060)', image: '/rings/1_Rose_Gold.png' },
      { id: 'white',     label: 'White Gold',  swatch: 'linear-gradient(135deg,#f0f0f0,#c0c0d0)', image: '/rings/1_Yello_Gold.png' },
    ],
  },
  {
    id: 'pave',
